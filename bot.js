...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    conn.on('message-new', async msg => {
        ...
        if (msg.messageStubType === 32 || msg.messageStubType === 28) {
            ...
            if (gb !== false) {
                await conn.sendMessage(msg.key.remoteJid, fs.readFileSync("/root/WhatsAsena/media/gif/VID-20210518-WA0060.mp4"), MessageType.video, {mimetype: Mimetype.mpeg, caption: gb.message});
            }
            return;
            ...
            if (gb !== false) {
                await conn.sendMessage(msg.key.remoteJid, fs.readFileSync("/root/WhatsAsena/media/gif/VID-20210518-WA0059.mp4"), MessageType.video, {mimetype: Mimetype.mpeg, caption: gb.message});
            }
            return;
        }
